...
/mob/living/carbon/human/New(var/new_loc, var/new_species = null)
	...
	if (prob(2)) // "30 cm penetrator"
		potenzia = rand(25,30)
	tits = (prob(80) ? rand(1, 2) : pick(rand(3, 4), rand(5, 6)))
...
/mob/living/carbon/human/Topic(href, href_list)
	...
	if(href_list["interaction"])
		...
		if (href_list["interaction"] == "bow")
		...
		else if (href_list["interaction"] == "mewbreasts")
			if((Adjacent(P) && !istype(P.loc, /obj/structure/closet)) || (H.loc == P.loc) && mouthfree && mouthfree_p)
				if (H.lust == 0)
					H.visible_message("<B>[H]</B> ласкает грудь <B>[P]</B>.")
					if (istype(P.loc, /obj/structure/closet))
						P.visible_message("<B>[H]</B> ласкает грудь <B>[P]</B>.")
					if (H.lust < 5)
						H.lust = 5
				else
					H.visible_message("<B>[H]</B> мнет грудь <B>[P]</B>.")
					if (istype(P.loc, /obj/structure/closet))
						P.visible_message("<B>[H]</B> мнет грудь <B>[P]</B>.")
			...
			if (!(Adjacent(P)) && hashands)
				...
				H.visible_message("<B>[H]</B> приветливо машет cвоей культей <B>[P]</B>.")
			...
			if(((Adjacent(P) && !istype(P.loc, /obj/structure/closet)) || (H.loc == P.loc)) && hashands)
				H.visible_message("<span class='danger'>[H] дает [P] подзатыльник!</span>")//Knocks?("<span class='danger'>[H] Р“В¤Р“В Р“ТђР“Р† [P] Р“Р‡Р“В®Р“В¤Р“В§Р“В Р“Р†Р“В»Р“В«Р“СР“В­Р“РЃР“Р„!</span>")
				if (istype(P.loc, /obj/structure/closet))
		...
		else if (href_list["interaction"] == "titlick")
			if(((Adjacent(P) && !istype(P.loc, /obj/structure/closet)) || (H.loc == P.loc)) && isnude_p && mouthfree && hasvagina_p)
				H.fuck(H, P, "titlick")
			...
			if (H.loc == P.loc && isnude_p && isnude && haspenis && hasanus_p)
				if (H.erpcooldown == 0)
					...
					var/message = pick("Не хочетс[ya] мне...", "Как-то нет желани[ya]...", "Что-то не охота...", "Нет, не сейчас.")//"Р“РЊР“Тђ Р“ВµР“В®Р“В·Р“ТђР“Р†Р“В±[ya] Р“В¬Р“В­Р“Тђ...", "Р“Р‰Р“В Р“Р„-Р“Р†Р“В® Р“В­Р“ТђР“Р† Р“В¦Р“ТђР“В«Р“В Р“В­Р“РЃ[ya]...", "Р“вЂ”Р“Р†Р“В®-Р“Р†Р“В® Р“В­Р“Тђ Р“В®Р“ВµР“В®Р“Р†Р“В ...", "Р“РЊР“ТђР“Р†, Р“В­Р“Тђ Р“В±Р“ТђР“В©Р“В·Р“В Р“В±.")
					H << message
			...
			if (H.loc == P.loc && isnude_p && isnude && haspenis && hasanus_p)
				if (H.erpcooldown == 0)
					...
					var/message = pick("Не хочетс[ya] мне...", "Как-то нет желани[ya]...", "Что-то не охота...", "Нет, не сейчас.")//, "Р“Р‰Р“В Р“Р„-Р“Р†Р“В® Р“В­Р“ТђР“Р† Р“В¦Р“ТђР“В«Р“В Р“В­Р“РЃ[ya]...", "Р“вЂ”Р“Р†Р“В®-Р“Р†Р“В® Р“В­Р“Тђ Р“В®Р“ВµР“В®Р“Р†Р“В ...", "Р“РЊР“ТђР“Р†, Р“В­Р“Тђ Р“В±Р“ТђР“В©Р“В·Р“В Р“В±.")
					H << message
			...
			if (H.loc == P.loc && isnude && isnude_p && haspenis_p && hasvagina)
				if (P.lust <= 0)
					var/message = pick("Инструмент не переведен в рабочее состо[ya]ние...", "У него еще не встал...", "А он лежит...", "Никак не насадитьс[ya]...")//"Р“в‚¬Р“В­Р“В±Р“Р†Р“В°Р“С–Р“В¬Р“ТђР“В­Р“Р† Р“В­Р“Тђ Р“Р‡Р“ТђР“В°Р“ТђР“СћР“ТђР“В¤Р“ТђР“В­ Р“Сћ Р“В°Р“В Р“РЋР“В®Р“В·Р“ТђР“Тђ Р“В±Р“В®Р“В±Р“Р†Р“В®[ya]Р“В­Р“РЃР“Тђ...", "Р“вЂњ Р“В­Р“ТђР“Р€Р“В® Р“ТђР“в„–Р“Тђ Р“В­Р“Тђ Р“СћР“В±Р“Р†Р“В Р“В«...", "Р“Р‚ Р“В®Р“В­ Р“В«Р“ТђР“В¦Р“РЃР“Р†...", "Р“РЊР“РЃР“Р„Р“В Р“Р„ Р“В­Р“Тђ Р“В­Р“В Р“В±Р“В Р“В¤Р“РЃР“Р†Р“СР“В±[ya]...")
					H << message
		...
		else if (href_list["interaction"] == "flick")
			if(((Adjacent(P) && !istype(P.loc, /obj/structure/closet)) || (H.loc == P.loc)) && isnude && mouthfree_p && hasvagina)
				H.fuck(H, P, "flick")
...
/mob/living/carbon/proc/get_social_class()
	...
	switch(socclass)
		if(SOCIAL_CLASS_MIN)
			return "<b>чернь</b>."
		if(SOCIAL_CLASS_MED)
			return "<b>пролетарий</b>."
		if(SOCIAL_CLASS_HIGH)
			return "<b>младший аристократ</b>."
		if(SOCIAL_CLASS_MAX)
			return "<b>старший аристократ</b>."
...
/mob/living/carbon/human/proc/choose_candidate()
	...
	var/mob/choice = input("Выбери своего кандидата.", "Выборы!") as mob in candidates

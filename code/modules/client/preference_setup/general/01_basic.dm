...
/datum/category_item/player_setup_item/general/basic/sanitize_character()
	...
	if(!pref.ideology || istype(pref.ideology, /datum/ideology))    pref.ideology = "Монархизм"
...
/datum/category_item/player_setup_item/general/basic/content()
	...
	. += "<b>Ideology</b>: <a href='?src=\ref[src];ideology=1'>[pref.ideology]</a><br/>"
...
/datum/category_item/player_setup_item/general/basic/OnTopic(var/href,var/list/href_list, var/mob/user)
	...
	else if(href_list["ideology"])
		var/chosen_ideology = input(user, "Выбери свою идеологию.") as null|anything in ideologies
		if(!chosen_ideology || !ideologies[chosen_ideology] || !CanUseTopic(user))	return TOPIC_NOACTION
		var/datum/ideology/I = ideologies[chosen_ideology]
		to_chat(user, I.description)
		pref.ideology = chosen_ideology

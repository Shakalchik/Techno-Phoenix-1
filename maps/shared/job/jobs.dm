...
/datum/job/chaplain
	title = "Kapelle"
	supervisors = "the Counselor und unser Gott sind Jesus Christus"
	minimal_player_age = 21
	economic_modifier = 3
	ideal_character_age = 30
	total_positions = 1
...
/datum/job/arbiter
	title = "Inquisitor"
	department = "Civilian"
	supervisors = "the Landmeister und Neues Christentum"
	faction = "Station"
	department_flag = CIV
	total_positions = 2
	spawn_positions = 2
...
/datum/job/supreme_arbiter
	title = "Landmeister"
	department = "Civilian"
	supervisors = "the Papst und unser Gott sind Jesus Christus"
	faction = "Station"
	department_flag = CIV
	total_positions = 1
	spawn_positions = 1
...
/datum/job/raider
	...
	equip(var/mob/living/carbon/human/H)
		...
		H.religion = IDEOLOGY_COMMUNISM//Their raiders they believe in the raider religion.
